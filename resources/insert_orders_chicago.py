...
with connection:
    for i in range(0, args.max_records):
        ...
        with connection.cursor() as cursor:
            ...
            sql = """
            INSERT INTO 
                chicago_online_orders (order_date, order_time_cst, purchaser, quantity, product_id )
            VALUES (
                CONCAT('%s-', FLOOR(RAND()*(12)+1), '-', FLOOR(RAND()*(29)+1)),
                CONCAT(FLOOR(RAND()*(12)+1), ':', FLOOR(RAND()*(59)+1), ':', FLOOR(RAND()*(59)+1)),
