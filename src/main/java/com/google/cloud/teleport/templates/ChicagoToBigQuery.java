...
import com.google.cloud.teleport.cdc.ChicagoJsonToTableRow;
 ...
 */
public class ChicagoToBigQuery {
  private static final Logger LOG = LoggerFactory.getLogger(ChicagoToBigQuery.class);
    ...
    pipeline
                      ...
                      DebeziumIO.<String>read()
                              .withConnectorConfiguration(
                                      DebeziumIO.ConnectorConfiguration.create()
                                              ...
                                              .withConnectionProperty("table.include.list", "inventory.chicago_online_orders")
              ...
              // Step 2: Transform Debezium event (Json) into TableRow, single field: json.
                ...
                .apply("Json to TableRow",
                        ParDo.of(new ChicagoJsonToTableRow()))
